  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        '每个模块需要简洁标题与一句目标说明。',
        '每个 plan-step 先给 1-2 个 introductions。它们会落成 summary 节点，必须是真正可读的前置讲解，不是问题标题。',
        'introductions 需要回答：这一步为什么学、前置概念是什么、和后续问题的关系是什么。',
  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        '每个步骤至少给出标题和一句目标说明。',
        '每个步骤必须先给至少 1 个 introductions。它们会直接落成 summary 节点，承担铺垫讲解，不是问题。',
  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        'judgment 必须明确表达“已答到”或“还不完整”。summary 必须给出可直接阅读的纠错/讲解文本。',
